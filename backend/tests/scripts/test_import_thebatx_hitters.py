"""Tests for import_thebatx_hitters script."""
...
from app.scripts.import_thebatx_hitters import import_thebatx_hitters
...
def _make_thebatx_row(
    ...
    """Build a TSV row string for a TheBatX hitter."""
    return (
...
class TestImportTheBatXHitters:
    """Integration tests for import_thebatx_hitters."""
    ...
    def test_imports_projection_with_thebatx_source(self, sync_engine):
        ...
        tsv_path = _write_tsv([_make_thebatx_row()])

        import app.scripts.import_thebatx_hitters as mod
        orig = mod.SessionLocal
        mod.SessionLocal = SL

        try:
            import_thebatx_hitters(str(tsv_path))
    ...
    def test_skips_rows_with_no_mlb_id(self, sync_engine):
        ...
        SL = sessionmaker(sync_engine, expire_on_commit=False)
        tsv_path = _write_tsv([_make_thebatx_row(mlb_id="")])
    ...
    def test_skips_rows_with_no_matching_player(self, sync_engine):
        ...
        SL = sessionmaker(sync_engine, expire_on_commit=False)
        tsv_path = _write_tsv([_make_thebatx_row(mlb_id="99999")])
    ...
    def test_two_way_player_prefers_non_pitcher(self, sync_engine):
        ...
        tsv_path = _write_tsv([_make_thebatx_row(name="Shohei Ohtani", mlb_id="660271")])
