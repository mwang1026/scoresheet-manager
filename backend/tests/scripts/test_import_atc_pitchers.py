"""Tests for import_atc_pitchers script."""
...
class TestImportAtcPitchers:
    """Integration tests for import_atc_pitchers."""
    ...
    def test_imports_projection_for_existing_player(self, sync_engine):
        ...
        tsv_path = _write_tsv([_make_atc_pitcher_row()])

        import app.scripts.import_atc_pitchers as mod
        orig = mod.SessionLocal
        mod.SessionLocal = SL

        try:
            import_atc_pitchers(str(tsv_path))
    ...
    def test_skips_rows_with_no_mlb_id(self, sync_engine):
        ...
        SL = sessionmaker(sync_engine, expire_on_commit=False)
        tsv_path = _write_tsv([_make_atc_pitcher_row(mlb_id="")])
    ...
    def test_skips_rows_with_no_matching_player(self, sync_engine):
        ...
        tsv_path = _write_tsv([_make_atc_pitcher_row(mlb_id="99999")])
    ...
    def test_two_way_player_prefers_pitcher(self, sync_engine):
        ...
        tsv_path = _write_tsv([_make_atc_pitcher_row(name="Shohei Ohtani", mlb_id="660271")])
