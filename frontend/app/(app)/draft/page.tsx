  ...
  return (
    <div className="flex flex-col h-full px-3 py-6 sm:px-6 lg:px-8">
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-6 min-h-0">
        ...
        <div className="flex-1 lg:flex-[3] overflow-y-auto min-h-[80vh] lg:min-h-0">
          <DraftQueuePanel
        ...
        <div className="flex-1 lg:flex-[2] lg:max-w-[460px] overflow-y-auto min-h-[80vh] lg:min-h-0">
          <DraftPicksPanel
            teams={teams ?? []}
