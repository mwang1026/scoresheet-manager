 ...
 * - Field transformations (snake_case → frontend format)
 * - Error handling
 */
 ...
 */
interface BackendHitterProjection {
  player_id: number;
  source: string;
  player_type: "hitter";
  season: number;
 ...
 */
interface BackendPitcherProjection {
  player_id: number;
  source: string;
  player_type: "pitcher";
  season: number;
...
type BackendProjection = BackendHitterProjection | BackendPitcherProjection;
 ...
 */
function transformTeam(backendTeam: BackendTeam): Team {
  return {
    id: backendTeam.id,
 ...
 */
function transformHitterStats(backendStats: BackendHitterStats): HitterDailyStats {
  return {
 ...
 */
function transformPitcherStats(backendStats: BackendPitcherStats): PitcherDailyStats {
  return {
    player_id: backendStats.player_id,
    date: backendStats.date,
    G: backendStats.g,
 ...
 */
function transformProjection(backendProj: BackendProjection): Projection {
